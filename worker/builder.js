...
export const schemas = {
  outline: S({
    ...
    components: arr(S({ id: str, name: str, paperCode: str, marks: int, weight: int, minutes: int, nea: bool, coversAll: bool, sections: arr(str) })),
