...
const SPEC_8700 = {
 ...
 "judged": {
  ...
  "familyFit": 0.95,
  "at": "2026-09-15",
  "by": "self-judged against .claude/skills/course-builder/references/judge.md in the build session, with every quoted span re-checked programmatically against spec.txt, 87001-SMS.txt, 87002-SMS.txt and 87002-SQP.txt",
  "invented": [
   "paperCode \"8700/1\" — not printed in any of the four documents supplied (only \"8700/2\" is, on the front of the specimen question paper); carried on the instruction of the build brief and flagged in notes"
  ],
  "missing": [],
  "changes": "The document is Version 1.5 14 October 2021 but prints no change log, errata or list of amendments from an earlier version. It says only: \"Are you using the latest version of this specification? You will always find the most up-to-date version of this specification on our website at [aqa.org.uk/8700]. We will write to you if there are significant changes to the specification.\" First teaching September 2015; first exams May/June 2017, \"and then every May/June and November for the life of the specification\"; November entries restricted to students \"at least 16 on the previous 31 August\". AQA entry code 8700, DfE discount code FK2B, QAN 601/4292/3. \"This specification overlaps with the AQA Level 1/Level 2 Certificate in English Language.\"",
