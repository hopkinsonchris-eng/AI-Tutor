...
const SPEC_8464 = {
 ...
 "markConventions": {
  ...
  "commandWords": [
   ...
   {
    "word": "Justify",
    "means": "Use evidence from the information supplied to support an answer."
   },
   {
    "word": "Give / Write / State / Name",
    "means": "Only a short answer is required, not an explanation or a description."
   }
  ],
  "essayShapes": [
   {
