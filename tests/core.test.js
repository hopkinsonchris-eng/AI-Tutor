...
ok('NT2 the voice says squared, cubed and to the power of, and reads subscripts as digits',C.speakable('v^2 = u^2 + 2as; V = x³; 10^-3; e^(kx); x^(1/2); H_2O')==='v squared equals u squared plus 2 a s; V equals x cubed; 10 to the power of minus 3; e to the power of k x; x to the power of 1 over 2; H 2 O',C.speakable('v^2 = u^2 + 2as; V = x³; 10^-3; e^(kx); x^(1/2); H_2O'));
