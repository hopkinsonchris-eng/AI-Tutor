/* AQA GCSE Mathematics (8300) — built by hand in a Claude Code session from the official specification PDF
   ...
   with each paper's marks, minutes and weight given in its sections. Judge: pending. */
const SPEC_8300 = {
 id: 'AQA-8300',
 board: 'AQA',
 subject: 'Mathematics',
 ...
 ao: [
  {
   ...
   text: 'Students should be able to: accurately recall facts, terminology and definitions; use and interpret notation correctly; accurately carry out routine procedures or set tasks requiring multi-step solutions. Overall weighting 50% at Foundation tier (40–60% of each paper) and 40% at Higher tier (30–50% of each paper).'
  },
  {
   id: 'AO2',
   label: 'Reason, interpret and communicate mathematically',
   text: 'Students should be able to: make deductions, inferences and draw conclusions from mathematical information; construct chains of reasoning to achieve a given result; interpret and communicate information accurately; present arguments and proofs; assess the validity of an argument and critically evaluate a given way of presenting information. Overall weighting 25% at Foundation tier (15–35% of each paper) and 30% at Higher tier (20–40% of each paper).'
  },
  {
   id: 'AO3',
   label: 'Solve problems within mathematics and in other contexts',
   text: 'Students should be able to: translate problems in mathematical or non-mathematical contexts into a process or a series of mathematical processes; make and use connections between different parts of mathematics; interpret results in the context of the given problem; evaluate methods used and results obtained; evaluate solutions to identify how they may have been affected by assumptions made. Overall weighting 25% at Foundation tier (15–35% of each paper) and 30% at Higher tier (20–40% of each paper).'
  }
 ],
 markConventions: {
  style: 'points',
  summary: 'Three papers of 80 raw marks each, scaled ×1 to a total scaled mark of 240 on which grade boundaries are set; graded on a nine-point scale 1 to 9 where 9 is the best grade (Foundation tier grades 1–5, Higher tier grades 4–9; below grade 1 is unclassified). Every paper can assess content from any part of the specification, and all papers must include questions that draw on elements from within and across different topic areas and questions that allow extended responses. Each content statement sits in one of three columns: basic foundation content (all students develop confidence and competence with it), additional foundation content (all students are assessed on it; more highly attaining students develop confidence and competence with all of it) and higher content only (assessed only at Higher tier, where all content can be assessed). Topic-area weightings prescribed by Ofqual for the tier as a whole: Number 25% Foundation / 15% Higher; Algebra 20% / 30%; Ratio, proportion and rates of change 25% / 20%; Geometry and measures 15% / 20%; Probability and statistics combined 15% / 15%. No calculator on Paper 1; a calculator is required on Papers 2 and 3. Pencil (for diagrams only), ruler, pair of compasses and protractor are expected on every paper. Students must recall, select and apply the formulae in the Appendix: those they must know (quadratic formula, circumference and area of a circle, Pythagoras’ theorem, the trigonometric ratios, the sine and cosine rules and Area = ½ab sin C), those they must know or be able to derive (area of a trapezium, volume of a prism, compound interest, the probability addition and multiplication formulae), and those given in the question (curved surface area of a cone, surface area and volume of a sphere, volume of a cone, the kinematics formulae). Marking conventions come from AQA’s published mark schemes, not the specification: M marks for a correct method which could lead to a correct answer, A marks for accuracy following a correct method (the method may be implied by a correct answer), B marks independent of method, ft for follow-through from an earlier error, oe for an equivalent form, SC for a special case; where a question says working must be shown, a correct answer with no working earns nothing.',
  commandWords: [
   { word: 'Solve', means: 'Find every value of the unknown that satisfies the equation or inequality (A17–A22). The mark scheme gives M marks for a correct method and A marks for the values; all solutions are required, and for an inequality the answer must keep the inequality sign.' },
   { word: 'Show that', means: 'The result is printed, so the marks are for the working: each line must follow from the last (A6 “argue mathematically to show algebraic expressions are equivalent”). Working to a printed answer is checked line by line; a proof at Higher tier needs a general argument, not examples.' },
   ...
   { word: 'Calculate', means: 'Work out a numerical value and show the method (N7–N9, G16–G23, P8–P9); give the answer to the accuracy asked for or an appropriate degree of accuracy (N15), with units where they apply, and do not round during intermediate steps.' },
   { word: 'Estimate', means: 'Approximate by rounding each value, typically to one significant figure, before calculating (N14), or read an approximate value from a graph (A15 “calculate or estimate gradients of graphs and areas under graphs”); the mark scheme accepts a range of answers.' },
   { word: 'Sketch', means: 'Draw the shape of a graph showing its key features — intercepts, turning points, asymptotes, the effect of a transformation — without plotting points (A12, A13); the marks are for the features, not for accuracy.' },
   { word: 'Plot', means: 'Mark points accurately from a table of values or a set of data and join or complete them appropriately (A9, A14, S6); accuracy is checked against a tolerance.' },
   { word: 'Construct', means: 'Produce an accurate ruler-and-compass drawing with the construction arcs left visible (G2), a plan or elevation (G13), a possibility space (P7), or an equation describing direct or inverse proportion (R13).' },
   ...
   { word: 'Factorise', means: 'Write an expression as a product: take out common factors, factorise quadratics of the form x² + bx + c including the difference of two squares, and at Higher tier ax² + bx + c (A4); a partial factorisation can earn the method mark only.' },
   { word: 'Rearrange', means: 'Change the subject of a formula (A5) by applying inverse operations to both sides in order; the mark scheme looks for each step and the final subject on its own.' },
   { word: 'Describe', means: 'Give the defining features in words: a transformation fully (G7 — rotation with centre, angle and direction; reflection with the mirror line; translation as a column vector; enlargement with centre and scale factor), a translation as a 2D vector (G24), or a correlation as positive, negative or none and weak or strong (S6).' },
 ...
 topics: [
  ...
  },
  {
   ...
   caseStudies: [
    ...
    'A12: Match sketches to y = x², y = x³, y = 1/x, y = 2ˣ and y = sin x; at Higher tier sketch y = cos x for 0° ≤ x ≤ 360°',
